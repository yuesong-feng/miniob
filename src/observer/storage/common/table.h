...
#define BYTE_BIT 8
#define BYTE_MOVE_BIT 7
#define NULLABLE_COLUMN 1
...
public:
  ...
  RC create_multi_index(Trx *trx, const char *index_name, char *attributes[], int attr_num, int is_unique);
...
public:
  ...
  Index *find_index_by_fields(std::vector<const char*> &field_names) const;
  // Index *find_index_by_fields(char *field_names[], int fields_num) const;
